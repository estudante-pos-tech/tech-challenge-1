...
Da forma como estão implementados os endpoints endereco, pessoa e eletromestico, são semalhantíssimos os métodos GET, POST, PUT e DELETE, nos 3 rest controllers.<br><br> 
