...
<br><br>**Requests incorretas** aos endpoints recebem **Http status codes** esperados numa api rest e o body da resposta padronizado de acordo com a **RFC 7807 - Problem Detail for Http Apis**. <br>
